...
<div id="container">
    <section>
        <div id="containerForm" class="row">
            <form class="needs-validation was-validated" method="post" action="disciplineModifying">
                <input type="hidden" name="idModifyDiscipline" value="${disc.id}">
                <div id="titleForm" class="form-group row">
                    <fmt:message key="titleFormDisciplinaModify"/>
                </div>
